...
var getForm = function (
    ...
    class ReactFormContainer extends React.Component {
        ...
        _onChange (e) {
            ...
            } else if (typeof manualRes == 'object') {
            	var masterFields = this.state.data.master;
            	var keyFound = false;
        ...
        render () {
                            ...
                            <div
                                        ...
                                        <div
                                            ...
                                            <div
	                                            ...
	                                            <button 
	                                                ...
	                                                >
                                                    <IconRemove style={{fill: 'white', marginTop: '-2px', marginRight: '5px', height: '10px', width: '10px'}} />
	                                                Remove
	                                            </button>
	                                        </div>
                                        </div>
                                ...
                                <div
                                    ...
                                    <button 
                                        ...
                                        // **Need to do something to avoid this binding
                                        >
                                        <IconAdd style={{fill: '#fff', marginTop: '-2.5px', marginRight: '3px', height: '18px', width: '18px'}} />
                                        Add
                                    </button>
                                </div>
                            </div>
            ...
            var children = generateChildren(fd, null, props.masterTag || null);
                    ...
                    {pages.length ?
                        <div>
                            ...
                            {showSubPageOption && Did ?
                                <button disabled={formActionEnabled ? false : true} onClick={this._deleteSubPage} className='btn btn-xs btn-danger'>Delete Sub-page</button>
                                    :
                                null
                            }
                            {/*
                            ...
                            <div>
                                <div>
                                    <button 
                                        ...
                                        >
                                        <IconSave style={{marginTop: '-2px', marginRight: '5px'}} />
                                        Save
                                    </button>
                                </div>
                                {pages.length > 1 ?
                                    <div style={{clear: 'both', padding: '8px'}}>
                                        <button data-val="-1" disabled={!formActionEnabled || !stateObj.curPage} onClick={this._alterPage} className='btn btn-xs btn-primary pull-left'><IconLeft style={{marginTop: '-2px', marginRight: '5px'}} />Previous</button>
                                        <button data-val="1" disabled={!formActionEnabled || pages.length - 1 == stateObj.curPage} onClick={this._alterPage} className='btn btn-xs btn-primary pull-right'>Next<IconRight style={{marginTop: '-2px', marginLeft: '5px'}} /></button>
                                    </div>
                                        :
                                    null
                                }
